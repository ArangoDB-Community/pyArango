...
**WARNING**: This version is only compatible with ArangoDB 2.x yet. For ArangoDB 3.X checkout the last master_ branch.

.. _master: https://github.com/tariqdaouda/pyArango/tree/master
